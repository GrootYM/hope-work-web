                ...
                <template slot-scope="scope">
                  <el-row :gutter="15">
                    <el-form ref="elForm" :model="scope.row" size="medium" label-width="100px">
                      ...
                      <el-col :span="12">
                        <el-form-item>
                          <el-button @click="updateEducation(scope.row)" style="font: center" round type="primary"
                            >保存
                          </el-button>
                          <el-button @click="delEducation(scope.row)" style="font: center" round type="danger"
                            >删除
                          </el-button>
                        </el-form-item>
                      </el-col>
                ...
                <template slot-scope="scope">
                  <el-row :gutter="15">
                    <el-form ref="elForm" :model="scope.row" size="medium" label-width="100px">
                      ...
                      <el-col :span="12">
                        <el-form-item>
                          <el-button @click="updateExperience(scope.row)" style="font: center" round type="primary"
                            >保存
                          </el-button>
                          <el-button @click="delExperience(scope.row)" style="font: center" round type="danger"
                            >删除
                          </el-button>
                        </el-form-item>
                      </el-col>
                ...
                <template slot-scope="scope">
                  <el-row :gutter="15">
                    <el-form ref="elForm" :model="scope.row" size="medium" label-width="100px">
                      ...
                      <el-col :span="12">
                        <el-form-item>
                          <el-button @click="updateProject(scope.row)" style="font: center" round type="primary"
                            >保存
                          </el-button>
                          <el-button @click="delProject(scope.row)" style="font: center" round type="danger"
                            >删除
                          </el-button>
                        </el-form-item>
                      </el-col>
