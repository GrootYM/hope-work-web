<template>
  <div class="loginPage">
    ...
    <div class="login-form" v-else>
      ...
      <div style="display: flex; margin: 0 auto 24px; position: relative; width: 37.04vh">
        <div style="font-size: 14px; color: #666666; margin-right: 16px">头像</div>
        <el-upload
          ref="headUpload"
          class="upload-demo"
        ...
        >
          <img class="avatar-upload" src="@/assets/image/login/camera.png" v-if="!form.headImg" />
          <div slot="file" slot-scope="{ file }">
            <img class="avatar-upload" :src="file.url" />
            <span class="el-upload-list__item-actions">
              <span v-if="!disabled" class="el-upload-list__item-delete" @click="handleHeadRemove(file)">
      ...
      <div class="input-container">
        <el-input v-model="form.userName" placeholder="请填写您的姓名" clearable @change="errorUserName = false">
        </el-input>
        <div class="el-form-item__error" v-if="errorUserName">请填写您的姓名</div>
      </div>
      <div class="input-container">
        <el-autocomplete
          style="width: 100%"
        ...
        <div class="el-form-item__error" v-if="errorCompany">请选择您所在的公司</div>
      </div>
      <div class="input-container" v-if="!isCompanyExisted">
        ...
        <div class="el-form-item__error" v-if="errorCompanyCode">请填写正确的社会信用代码</div>
      </div>
      <div class="img-upload" v-if="!isCompanyExisted">
        ...
        <div class="el-form-item__error" v-if="errorFile">请上传贵公司营业执照</div>
      </div>
      <div class="input-container">
        <el-input v-model="form.roleName" placeholder="请填写您的职务" clearable @change="errorRoleName = false">
        </el-input>
        <div class="el-form-item__error" v-if="errorRoleName">请填写您的职务</div>
      </div>
