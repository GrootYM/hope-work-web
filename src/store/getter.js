...
export const userBasicInfo = state => state.userBasicInfo

export const userEduInfo = state => state.userEduInfo

export const userExpectedPosition = state => state.userExpectedPosition

export const userLastExperience = state => state.userLastExperience

export const oxTitle = state => (state.oxTitle ? state.oxTitle : localStorage.getItem('oxTitle'))

export const cityName = state => state.cityName

export const provinceObj = state => state.province

export const userMobile = state => state.mobile
/**
